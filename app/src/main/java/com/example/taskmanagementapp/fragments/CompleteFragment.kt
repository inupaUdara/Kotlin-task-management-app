...
import com.example.taskmanagementapp.databinding.FragmentCompleteBinding
...
class CompleteFragment : Fragment(R.layout.fragment_complete), SearchView.OnQueryTextListener, MenuProvider {
    ...
    private fun setupHomeRecycleView(){
        ...
        activity?.let {
            taskViewModel.getCompleteTasks().observe(viewLifecycleOwner) { task ->
